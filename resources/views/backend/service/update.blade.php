    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <form id="cerfitication" action="{{$data->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="card-body">
                <div id="imgList" 
                    style="
                        ...
                        margin-bottom: 20px;
                    ">
                    <img style="width:100%; height:100%; border-radius:50%; object-fit:cover;" id="thumbnail_prev" src="{{$data->thumbnail ? $data->thumbnail : asset('upload_thumbnail/empty_img.png')}}"  alt="..">
                </div>
