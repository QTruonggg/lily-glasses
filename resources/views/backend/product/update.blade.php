                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="seo_keyword" name="seo_keyword" value="{{$product->seo_keyword}}" class="form-control" placeholder="Nhập  từ khóa ">
                                         @error('seo_keyword')
                                        <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <textarea class="form-control" id="summary-ckeditor" name="seo_description" value="{{$product->seo_description}}">{{$product->seo_description}}</textarea>
