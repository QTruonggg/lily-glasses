                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="subname" name="subname"  value="{{$policy_detail->subname}}" class="form-control" placeholder="">
                                        @error('slug')
                                        <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <textarea class="form-control" id="summary-ckeditor" name="seo_description">{{$policy_detail->seo_description}}</textarea>
