...
<div class="card">
    <div class="card-body border-bottom d-flex justify-content-between align-items-center">
        ...
        <a href="{{route('shared.create')}}"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
           Thêm mới
        </button></a>
    </div>
                ...
                <tbody>
                    ...
                    <tr id="row" class="text-center">
                        ...
                        <td class="project-actions" style="text-align: right;">
                            <a href="{{route('shared.getUpdate', [$item->id])}}" class="btn btn-sm btn-icon">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">
                                    ...
                                    <a href="deleteShared/{{$item->id}}"  type="button" class="btn btn-danger">Xóa</a>
                                </div>
                            </div>
                        </div>
                    </div>
